...
## Expanded Skills Build

This package includes exactly 65 curated, locally rendered technology entries across 8 animated categories. No network request is required for the skill icons. Motion automatically pauses on hover and respects reduced-motion settings.
