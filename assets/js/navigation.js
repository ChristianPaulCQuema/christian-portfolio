...
(function () {
  ...
  function initDrawer() {
    ...
    toggle.addEventListener("click", function (event) {
      /* setOpen swaps the button's icon, which detaches the clicked <svg>. The
         outside-click handler below would then see an orphaned event.target,
         decide the click landed outside, and close the menu again straight away.
         Stopping propagation here keeps open/close entirely with this handler. */
