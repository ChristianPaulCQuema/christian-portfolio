...
(function () {
  ...
  function buildTrack(items) {
    ...
    /* Render two identical sets inside one moving track. This creates a
       seamless loop on wide desktop screens without native scrollbars. */
    items.forEach(function (tech) { track.appendChild(buildPill(tech)); });
    items.forEach(function (tech) {
      var duplicate = buildPill(tech);
      duplicate.setAttribute("aria-hidden", "true");
      duplicate.removeAttribute("title");
